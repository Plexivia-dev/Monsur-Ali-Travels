...
এই গাইডে দেখানো হয়েছে কীভাবে একটি ডোমেইন (যেমন: `monsuralitravelsbd.com`) DNS ম্যানেজমেন্টের মাধ্যমে VPS-এর আইপি ঠিকানায় পয়েন্ট করতে হয় এবং Nginx ব্যবহার করে ডোমেইনটিকে ডকার কন্টেইনারের নির্দিষ্ট পোর্টের (যেমন: ফ্রন্টএন্ড পোর্ট ৮০০১) সাথে যুক্ত করতে হয়।
...
1. **Root Domain-এর জন্য:**
   - **Type:** `A`
   - **Name / Host:** `@` (অথবা আপনার মূল ডোমেইন নাম যেমন: `monsuralitravelsbd.com`)
...
```bash
sudo nano /etc/nginx/sites-available/monsuralitravelsbd.com
...
server {
    listen 80;
    server_name monsuralitravelsbd.com [www.monsuralitravelsbd.com](https://www.monsuralitravelsbd.com);
...
```bash
sudo ln -s /etc/nginx/sites-available/monsuralitravelsbd.com /etc/nginx/sites-enabled/
sudo nginx -t
...
```bash
sudo certbot --nginx -d monsuralitravelsbd.com -d [www.monsuralitravelsbd.com](https://www.monsuralitravelsbd.com)
...
এখন ব্রাউজারে সরাসরি `https://monsuralitravelsbd.com` লিখে ভিজিট করলেই আপনার VPS-এর ডকার কন্টেইনারে চলা ফ্রন্টএন্ড অ্যাপটি লাইভ দেখতে পাবেন।
