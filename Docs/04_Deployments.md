...
## 1. Monsur Ali Travels VPS Host (`144.79.218.126`)

### A. Environment Paths & Volumes
- **Primary Codebase (Live):** `/opt/live` (Branch: `Live`)
- **Legacy Codebase (Dev):** `/opt/dev` (Branch: `Monsur Ali Travels`)
- **Client Configuration Root:** `/opt/monsuralitravels/configs/`
- **Uploads/Assets Directory:** `/var/www/uploads/` & `/opt/monsuralitravels/uploads/`

### B. Active Containers & Port Routing
| Container Name | Service / Role | Host Port | Internal Port | Domain / Routing | Firewall Rule |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **`monsuralitravels-backend-live`** | Express Node.js API | `5093` | `5093` | `https://service.monsuralitravelsbd.com` & `https://server.monsuralitravelsbd.com` | Allowed publicly |
| **`monsuralitravels-dashboard-live`** | Next.js Dashboard | `8015` | `8005` | `https://v2.monsuralitravelsbd.com` | Allowed publicly |
| **`monsuralitravels-mongodb-live`** | MongoDB Engine | `27017` | `27017` | Direct Access / Local IP | Whitelisted IP only |
| **`monsuralitravels-backend-dev`** | Legacy Dev API | `5092` | `5092` | Direct Access (No Nginx domain routing) | Allowed publicly |
| **`monsuralitravels-dashboard-dev`** | Legacy Dev Dashboard (Stopped) | `8005` | `8005` | `https://dashboard.monsuralitravelsbd.com` (Stopped) | Allowed publicly |
| **`monsuralitravels-mongodb-dev`** | Dev MongoDB Engine (Stopped) | `None` | `27017` | N/A | Whitelisted IP only |
| **`monsuralitravels-frontend-dev`** | Legacy Dev Frontend (Stopped) | `8001` | `8001` | `https://monsuralitravelsbd.com` (Stopped) | Allowed publicly |
...
```
*(On Monsur Ali Travels VPS, the active port is `27017` (live). On Engulfic VPS, ports are `27017` and `27018`).*
