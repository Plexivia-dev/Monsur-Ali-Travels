...
export const MonsurAliTravelsLogo = ({
  ...
  const { clientKey = 'monsuralitravels', brandName = 'Monsur Ali Travels', logoUrl } = clientConfig || {};

  // Resolve target logo URL (Prop > Client Config > Env Var > Default asset path)
  const rawUrl = src || logoUrl || import.meta.env?.VITE_LOGO_URL || `/src/uploads/assets/${clientKey === 'monsuralitravels' ? 'monsuralitravels_logo.png' : `${clientKey}_logo.png`}`;
