...
function Card({ className, size = 'default', ...props }) {
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card bg-card text-card-foreground border border-border/80 flex flex-col gap-4 overflow-hidden rounded-xl p-5 text-sm shadow-xs transition-colors',
        className
      )}
      {...props}
    />
