      ...
      <div className="bg-card border border-border p-5 rounded-2xl shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-foreground tracking-tight flex items-center gap-2">
            ...
            Server Document Repository & Downloads
          </h2>
          <p className="text-xs text-muted-foreground mt-1">
            Access pre-uploaded official backup files, visa guidelines, agreement forms, and print templates directly from server (<code className="font-mono text-[11px] text-primary">/var/www/html/documents</code>).
          </p>
        </div>

        <div className="flex items-center gap-3 bg-muted/60 border border-border px-3.5 py-2 rounded-xl text-xs shrink-0">
          <HardDrive className="w-4 h-4 text-emerald-500 shrink-0" />
          <div>
            <span className="font-bold text-foreground block">Server Location</span>
            <span className="text-[11px] text-muted-foreground font-mono">var/www/html/documents</span>
          </div>
        </div>
      </div>
