...
export function getDefaultJobVerificationData() {
  return {
    ...
    jobStayDetails: {
      ...
      accommodationType: 'Company Provided Accommodation',
      residenceAddress: '',
      jobNature: 'General & Agricultural Worker',
      jobTitle: 'Field Worker / Operative',
      dailyWorkingHours: '8 Hours / Day',
      weeklyWorkingHours: '48 Hours / Week',
      salaryAmount: '850',
      currency: 'EUR',
    },
    ...
    helperInfo: {
      ...
      knowsHelper: 'Yes',
      durationKnown: 'Known for 5+ years (Family relation)',
      helperDob: '',
      helperPhone: '',
    },
