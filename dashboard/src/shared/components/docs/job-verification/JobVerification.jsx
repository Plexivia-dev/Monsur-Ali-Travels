...
import { Printer, Edit3, CheckCircle2, Share2, Briefcase } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {viewMode === 'preview' && (
        <div className="space-y-6">
          ...
          <div className="no-print bg-card border border-border p-4 sm:p-5 rounded-xl shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className="text-base font-bold text-foreground tracking-tight flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-emerald-500" />
                Job Verification Document Ready (ID:{' '}
                <span className="font-mono text-emerald-600 font-bold">{data.verificationId}</span>)
              </h2>
              <p className="text-xs text-muted-foreground mt-0.5">
                The verification document is saved and ready. You can print, download PDF, share on WhatsApp, or edit details.
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0 flex-wrap">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold border border-border bg-muted/40 hover:bg-muted text-foreground transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white text-xs font-bold px-4 py-2 rounded-xl shadow-xs hover:shadow-sm transition-all cursor-pointer shrink-0"
                title="Share Verification Summary on WhatsApp"
              >
              ...
              <button
                type="button"
                onClick={handlePrint}
                className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold px-5 py-2 rounded-xl shadow-xs hover:shadow-sm transition-all cursor-pointer shrink-0"
              >
