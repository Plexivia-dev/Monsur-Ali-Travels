    ...
    <div className="space-y-6 pb-12 animate-in fade-in duration-200">
      ...
      <div className="bg-card border border-border/80 rounded-2xl p-5 sm:p-6 shadow-xs space-y-4">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-border/60 pb-4">
          ...
          <div className="flex items-center gap-3 bg-muted/30 p-2 sm:p-2.5 rounded-2xl border border-border/80 shrink-0 self-start lg:self-center">
            <div className="text-left sm:text-right pr-1">
              <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground block">
                Processing Stage
              </span>
              <span className="text-xs font-semibold text-primary block truncate max-w-[140px]">
                {formatCleanLabel(caseData.workflowStatus || caseData.status, 'In Progress')}
              </span>
            </div>
            <div className="relative">
              <select
                ...
                className="appearance-none pl-3 pr-8 py-1.5 text-xs font-bold rounded-xl border border-border bg-card text-foreground hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-primary/20 cursor-pointer shadow-2xs transition-all"
              >
