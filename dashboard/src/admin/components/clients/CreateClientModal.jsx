    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-5 overflow-hidden animate-in fade-in duration-200">
      <div className="bg-white text-zinc-900 rounded-2xl border border-black/10 shadow-2xl max-w-2xl w-full h-[70vh] flex flex-col overflow-hidden relative animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden flex-1 min-h-0 relative z-10">
          <div className="p-6 overflow-y-auto space-y-5 flex-1 min-h-0 text-xs text-black">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 text-xs font-semibold rounded-xl border border-black/15 bg-white text-black focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary cursor-pointer"
                  >
                    <option value="WORK_PERMIT" className="bg-white text-black">Work Permit Visa</option>
                    <option value="INDIAN_VISA" className="bg-white text-black">Indian Visa</option>
                    <option value="PASSPORT_SERVICE" className="bg-white text-black">Passport Application</option>
                    <option value="TOURIST_VISA" className="bg-white text-black">Tourist / Visit Visa (Tourist Visa)</option>
                    <option value="UMRAH_HAJJ" className="bg-white text-black">Umrah / Hajj Package</option>
                    <option value="OTHER" className="bg-white text-black">Other Consular Service</option>
                  </select>
                </div>
                ...
                {isWorkPermit && (
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3.5 py-2.5 text-xs font-semibold rounded-xl border border-black/15 bg-white text-black focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary cursor-pointer"
                    >
                      <option value="Greece" className="bg-white text-black">Greece</option>
                      <option value="North Macedonia" className="bg-white text-black">North Macedonia</option>
                      <option value="Other" className="bg-white text-black">Other Country</option>
                    </select>
                  </div>
                )}

                {isIndianVisa && (
                  <div className="flex flex-col justify-center p-3 rounded-xl bg-amber-500/10 border border-amber-500/30 shadow-2xs">
                    <div className="flex items-center gap-2 font-bold text-amber-900 text-xs">
                      <Stamp className="size-4 text-amber-600 shrink-0" />
                ...
                {isPassportService && (
                  <div className="flex flex-col justify-center p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/30 shadow-2xs">
                ...
                {isUmrah && (
                  <div className="flex flex-col justify-center p-3 rounded-xl bg-blue-500/10 border border-blue-500/30 shadow-2xs">
                    <div className="flex items-center gap-2 font-bold text-blue-900 text-xs">
                      <Plane className="size-4 text-blue-600 shrink-0" />
                      <span>Destination: Saudi Arabia</span>
                    </div>
                    <span className="text-[11px] text-blue-800 font-medium mt-1">
                ...
                {!isWorkPermit && !isIndianVisa && !isPassportService && !isUmrah && (
                  <div>
                    ...
                    <select
                      ...
                      value={formData.destinationCountry}
                      onChange={handleChange}
                      className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-black/15 bg-white text-black focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary cursor-pointer"
                    >
                      <option value="Saudi Arabia" className="bg-white text-black">Saudi Arabia</option>
                      <option value="United Arab Emirates" className="bg-white text-black">Dubai / UAE</option>
                      <option value="Qatar" className="bg-white text-black">Qatar</option>
                      <option value="Oman" className="bg-white text-black">Oman</option>
                      <option value="Kuwait" className="bg-white text-black">Kuwait</option>
                      <option value="Singapore" className="bg-white text-black">Singapore</option>
                      <option value="Malaysia" className="bg-white text-black">Malaysia</option>
                      <option value="Thailand" className="bg-white text-black">Thailand</option>
                      <option value="Other" className="bg-white text-black">Other Country</option>
                    </select>
                  </div>
                )}
                ...
                formData.destinationCountry === 'Other' && (
                  <div className="animate-in fade-in duration-200">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-primary/40 bg-white text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                    />
                  </div>
                )}
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 p-1.5 bg-black/[0.03] rounded-xl border border-black/10">
                <label
              ...
              {clientMode === 'existing' && (
                <div className="space-y-3 animate-in fade-in duration-200">
                  <div className="relative" ref={searchContainerRef}>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-8 py-2.5 text-xs rounded-xl border border-black/15 bg-white text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-medium"
                      />
                      {searching && (
                    ...
                    {dropdownOpen && searchResults.length > 0 && (
                      <div className="absolute top-full left-0 right-0 mt-1.5 max-h-56 overflow-y-auto bg-white border border-black/10 rounded-xl shadow-2xl z-30 divide-y divide-black/10">
                        {searchResults.map((client) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full text-left p-3 hover:bg-black/[0.02] transition-colors flex items-center justify-between cursor-pointer ${
                            ...
                            >
                              <div className="space-y-0.5 min-w-0 pr-2">
                                ...
                                <div className="text-[11px] text-black/60 flex items-center gap-3">
                  ...
                  {selectedClient && (
                    <div className="p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-xs space-y-1 animate-in fade-in duration-150">
                      <div className="flex items-center justify-between font-bold text-emerald-800">
                        <span>Selected: {selectedClient.fullName}</span>
                        <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-800">
                          {selectedClient.clientCode || 'Client'}
                        </span>
                      </div>
                      <div className="text-[11px] text-black/80 grid grid-cols-2 gap-2 pt-1">
                        <div>Phone: <span className="font-mono text-black">{selectedClient.phone || '—'}</span></div>
                        <div>Email: <span className="text-black">{selectedClient.email || '—'}</span></div>
                        <div>Passport: <span className="font-mono text-black">{selectedClient.passportNumber || '—'}</span></div>
                        <div>NID: <span className="font-mono text-black">{selectedClient.nidNumber || '—'}</span></div>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-in fade-in duration-200">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-black/15 bg-white text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-black/15 bg-white text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-mono"
                    />
                  </div>
                  ...
                  {!isPassportService && (
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-black/15 bg-white text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-mono uppercase"
                      />
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Corporate" className="bg-white text-black">Corporate / Agency</option>
                      <option value="VIP" className="bg-white text-black">VIP Client</option>
                      <option value="Lead" className="bg-white text-black">Lead / Prospect</option>
                    </select>
                  </div>
                </div>
              )}
            ...
            <div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-black/15 bg-white text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-mono font-bold"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-black/15 bg-white text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none"
              ></textarea>
            </div>
          </div>
