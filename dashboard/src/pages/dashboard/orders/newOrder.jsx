  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const orderPayload = {
        ...
        email: customerEmail.trim() || "instore@monsuralitravels.com",
      ...
      const invoiceUrl = `https://monsuralitravels.com/invoice/${orderNumber}`;
      ...
      setCompletedOrder({
        ...
        customerEmail: customerEmail.trim() || "instore@monsuralitravels.com",
  ...
  const handleSendInvoice = async () => {
    ...
    try {
      ...
      await apiClient.post("/api/v1/sendEmail/invoice", {
        ...
        notes: "Thank you for shopping with Monsur Ali Travels.",
      });
