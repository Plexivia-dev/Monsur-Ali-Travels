 ...
 * @param {string} [params.logoUrl] - Public Monsur Ali Travels logo URL
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="content">
        ...
        <p class="subtitle">
          You have requested to set up Google Authenticator for your Monsur Ali Travels Dashboard (https://dashboard.monsuralitravelsbd.com).
        ...
        <p class="security-notice">
          ...
          and contact the Monsur Ali Travels support team. Do not share this QR code or key with anyone.
        </p>
      </div>
      ...
      <div class="footer">
        ...
        <p>monsuralitravelsbd.com &mdash; Dashboard Security Notification</p>
      </div>
