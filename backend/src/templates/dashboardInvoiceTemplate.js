...
<body>
  <div class="invoice-container">
    ...
    <div class="invoice-header">
      <div class="logo">
        <img src="${logoUrl}" alt="Monsur Ali Travels" style="height: 28px; width: auto; display: block;" />
      </div>
    ...
    <div class="invoice-body">
      ...
      <div class="address-grid">
        ...
        <div class="address-block">
          ...
          <p>
            ${isInStore
              ? `<strong>🏢 Office Pickup (In-Store)</strong><br><span style="color: #6B7280; font-size: 11px;">Customer will pick up from Monsur Ali Travels Office.</span>`
