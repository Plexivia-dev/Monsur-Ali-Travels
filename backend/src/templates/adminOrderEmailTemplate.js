 ...
 * @param {string} [params.logoUrl="https://server.monsuralitravelsbd.com/uploads/logo_horizontal.png"] - Public Monsur Ali Travels Logo URL
 * @returns {string} HTML string
 */
export const buildAdminOrderEmailHtml = ({
  order = {},
  logoUrl = "https://server.monsuralitravelsbd.com/uploads/monsuralitravels_logo.png"
}) => {
  const {
    orderId = "3870",
  ...
  const logoMarkup = `<img class="logo" src="${logoUrl}" alt="Monsur Ali Travels Dev" width="187.5" height="30" style="width: 187.5px; height: 30px; max-width: 187.5px; max-height: 30px; display: block; margin: 0 auto; border: 0; outline: none;" />`;
...
<head>
  ...
  <title>Monsur Ali Travels Dev - New Order #${orderId}</title>
  <!-- Google Fonts Import -->
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div style="text-align: center; margin: 30px 0 10px 0;" class="no-print">
          <a href="https://server.monsuralitravelsbd.com/api/v1/orders/${orderId}/invoice" target="_blank" style="display: inline-block; padding: 12px 28px; background-color: #C5A059; color: #000000; text-decoration: none; border-radius: 6px; font-weight: 700; font-family: 'Geist Mono', sans-serif; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 4px 12px rgba(197, 160, 89, 0.25);">
      ...
      <!-- Dark Footer -->
      <div class="footer">
        <p>&copy; ${new Date().getFullYear()} <a href="https://monsuralitravelsbd.com">Monsur Ali Travels Dev</a>. All rights reserved. <span style="color: #C5A059; font-size: 10px;">[TEST]</span></p>
      </div>
