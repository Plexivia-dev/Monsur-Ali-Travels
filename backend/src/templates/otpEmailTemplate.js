...
<body>
  <div class="wrapper">
    <div class="container">
      ...
      <div class="header">
        <img class="logo" src="${logoUrl}" alt="Monsur Ali Travels" width="187.5" height="30" style="width: 187.5px; height: 30px; max-width: 187.5px; max-height: 30px; display: block; margin: 0 auto; border: 0;" />
      </div>
      ...
      <div class="content">
        ...
        <p class="message-text">
          Thank you for choosing Monsur Ali Travels. To complete your verification, please use the One-Time Password (OTP) provided below:
        </p>
      ...
      <!-- Dark Footer -->
      <div class="footer">
        <p>&copy; ${new Date().getFullYear()} <a href="https://monsuralitravelsbd.com">Monsur Ali Travels</a>. All rights reserved.</p>
      </div>
