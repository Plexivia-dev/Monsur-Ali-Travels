...
const handleInvoiceRequest = async (req, res) => {
  ...
  const invoiceData = {
    ...
    sellerName: req.body.sellerName || req.query.sellerName || "Monsur Ali Travels",
    ...
    logoUrl: req.body.logoUrl || req.query.logoUrl || "https://server.monsuralitravelsbd.com/uploads/logo.webp",
  };
