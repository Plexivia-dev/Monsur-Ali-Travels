...
employeeRouter.get("/", authorizeRoles("Owner", "Admin", "Superadmin", "Accountant", "accounts", "Staff", "frontdesk", "Manager"), listEmployees);
employeeRouter.get("/:id", authorizeRoles("Owner", "Admin", "Superadmin", "Accountant", "accounts", "Staff", "frontdesk", "Manager"), getEmployeeById);
