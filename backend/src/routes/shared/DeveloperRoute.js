...
developerRouter.get(
  ...
  (req, res) => {
    const openApiSpec = {
      openapi: "3.0.0",
      info: {
        title: "Monsur Ali Travels BD Fullstack API Specification",
        description: "Modern, high-performance API Reference & Live Endpoint Tester for Monsur Ali Travels BD Backend.",
        version: "2.0.1"
      },
      servers: [
        { url: "https://server.monsuralitravelsbd.com/api/v1", description: "Live Server" },
...
<head>
  ...
  <title>Monsur Ali Travels API Documentation (Scalar)</title>
  <style>
